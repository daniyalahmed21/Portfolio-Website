  ...
  return (
    <div className="flex flex-col items-start w-full max-w-xl">
      ...
      >
        ...
        <span className="text-[#dcdcf9] block">Bugged Dev</span>
      </h1>

      {/* Subtext */}
      <p className="text-[#8888AA] text-lg leading-relaxed max-w-md mb-12">
        I vibe code AI powered products with React Three.js and TypeScript. I
        design the motion and ship the code with care.
      </p>
